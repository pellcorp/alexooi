...
public class WordTransformer
{
    ...
    {
        this.uncountables.addAll(Arrays.asList("equipment", "information", "rice", "money", "species", "series", "fish", "sheep"));
        ...
        this.singulars.addFirst(new TransformationRule("((a)naly|(b)a|(d)iagno|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$", "$1$2sis"));
    ...
    public void addIrregular(String singular, String plural)
    {
        ...
        this.singulars.addFirst(new TransformationRule("(" + plural.charAt(0) + ")" + pluralRemainder + "$", "$1" + singularRemainder));
    }
