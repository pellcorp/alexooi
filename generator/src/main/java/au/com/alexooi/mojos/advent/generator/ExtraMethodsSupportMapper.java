...
{
    private static final Logger LOG = Logger.getLogger(ExtraMethodsSupportMapper.class);
    ...
    Map<Class, Class<ExtraBuilderMethodsSupport>> map(List<String> extraMethodSupportFqns)
    {
        try
        {
            ...
            {
                Class<ExtraBuilderMethodsSupport> extraMethodsSupportClazz =
                    (Class<ExtraBuilderMethodsSupport>) classLoader.loadClass(extraMethodsFqn);
        ...
        Class<ExtraBuilderMethodsSupport> extraMethodsSupportClazz) throws ClassNotFoundException
    {
        ...
        {
            LOG.warn("The clazz [" + extraMethodsSupportClazz + "] is not annotated with" +
        ...
        Class<ExtraBuilderMethodsSupport> extraMethodsSupportClazz, Class forClazz, List<Class> clazzHierarchy)
    {
        ...
        {
            LOG.warn("The clazz [" + extraMethodsSupportClazz + "] is annotated with " +
